...
cout<<"\n\n\n\n";
     cout<<"\t\t\t\tYour carrier ship will have a pointer"<<"1"<<endl;
     cout<<"\t\t\t\tYour battle ship will have a pointer"<<"2"<<endl;
    cout<<"\t\t\t\tYour cruiser ship will have a pointer"<<" 3"<<endl;
    cout<<"\t\t\t\tYour Submarine ship will have a pointer"<<" 4"<<endl;
    cout<<"\t\t\t\tYour Destroyer ship will have a pointer"<<" 5"<<endl;
}
//function for displaying names
void credit()
{	cout<<setw(60)<<"Designed By:"<<endl;
	cout<<setw(60)<<"Kamla Safdar"<<endl;
	cout<<setw(60)<<"Laiba Zafar"<<endl;
}
//function for displaying rules
void rules()
{   
cout<<"Rules:"<<endl;
 cout<<setw(45)<<"Each player places the 5 ships somewhere on their board"<<endl;
 cout<<setw(45)<<"The ships can only be placed vertically or horizontally"<<endl;
 cout<<setw(45)<<"Diagonal placement is not allowed                      "<<endl;
 cout<<setw(45)<<"No part of a ship may hang off the edge of the board"<<endl;
 cout<<setw(45)<<"Once the guessing begins, the players may not move the ships"<<endl;
 cout<<setw(45)<<"No ships may be placed on another ship"<<endl;
 cout<<setw(45)<<"The 5 ships are:  Carrier , Battleship , Cruiser , Submarine , and Destroyer"<<endl;
}
...
{   
	 system("color 4F");
     spaces();
     cout<<setw(60);cout<<"BATTLESHIP"<<endl<<endl;
     cout<<setw(35);cout<<"Sink other before they sink you"<<endl;
     sleep(3);
     system("cls");
     spaces();
     credit();
     ...
     system("cls");
     spaces();
     cout<<setw(64);cout<<"THE GAME CONSITS OF TWO MODES: \n";
     cout<<setw(57);cout<<"1.Player VS. Player \n";
     cout<<setw(59);cout<<"2.Player VS. Computer \n";
     cout<<setw(60); cout<<"Enter your Play Mode:  ";
     cout<<setw(60);cin>>mode;
     cout<<setw(60);cout<<"Game consits of Three levels:\n";
     cout<<setw(57);cout<<"1.EASY\n";
     cout<<setw(57);cout<<"2.MEDIUM \n";
     cout<<setw(57);cout<<"3.HARD \n";
      cout<<setw(60); cout<<"Enter your level type:  ";
      cin>>type;
     system("cls");
     ...
     switch(mode)
     {
     	...
     	{
     	spaces();
		 cout<<setw(70);cout<<"You have choosed Player Vs. Player mode \n";
		 cout<<setw(60);cout<<"It's Player 1 Turn first! \n";
     	 menu();
	     sleep(7);
         system("cls");
         centre();
    ...
    if(type==1)
	 ...
	 case 2:
	 {
	      system("color 3F");
	 	  spaces();
	 	  player=1;
	 	  cout<<setw(75);cout<<"You have choosed Player Vs.Computer mode \n";
		  cout<<setw(65);cout<<"It's Player 1 Turn first! \n";
		   sleep(3);
          //system("cls");
         menu();
	     sleep(3);
